...
* Strictly adhering to the "No AI tool shaming" principle of the registry

Examples of unacceptable behavior include:

* The use of sexualized language or imagery
* Trolling, insulating or derogatory comments, and victim-blaming
...
Contact `maintainers@korext.com` to report issues.
